...
interface ButtonCarpProps {
    onPress: () => void,
}

function ButtonCarp(props: ButtonCarpProps): JSX.Element {
    return (
        <TouchableOpacity style={styles.tuscarpma} onPress={() => props.onPress()}>
