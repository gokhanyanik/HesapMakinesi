...
interface ButtonIkiProps {
    onPress: () => void,
}

function ButtonIki(props: ButtonIkiProps): JSX.Element {
    return (
        <TouchableOpacity style={styles.tus2} onPress={() => props.onPress()} >
