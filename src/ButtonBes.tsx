...
interface ButtonBesProps {
    onPress: () => void,
}

function ButtonBes(props: ButtonBesProps): JSX.Element {
    return (
        <TouchableOpacity style={styles.tus5} onPress={() => props.onPress()} >
