...
interface ButtonSekizProps {
    onPress: () => void,
}

function ButtonSekiz(props: ButtonSekizProps): JSX.Element {
    return (
        <TouchableOpacity style={styles.tus8} onPress={() => props.onPress()} >
