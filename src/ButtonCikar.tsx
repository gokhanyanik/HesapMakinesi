...
interface ButtonCikarProps {
    onPress: () => void,
}

function ButtonCikar(props: ButtonCikarProps): JSX.Element {
    return (
        <TouchableOpacity style={styles.tuscikarma} onPress={() => props.onPress()}>
