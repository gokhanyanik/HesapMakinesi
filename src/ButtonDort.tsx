...
interface ButtonDortProps {
    onPress: () => void,
}

function ButtonDort(props: ButtonDortProps): JSX.Element {
    return (
        <TouchableOpacity style={styles.tus4} onPress={() => props.onPress()} >
