...
interface ButtonAltiProps {
    onPress: () => void,
}

function ButtonAlti(props: ButtonAltiProps): JSX.Element {
    return (
        <TouchableOpacity style={styles.tus6} onPress={() => props.onPress()} >
